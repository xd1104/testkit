...
const category = "通用";
const description =
  "自動執行：由你的 Claude Code 實際跑「註冊 → 登入 → 登出」，報告直接出現在這裡。Claude 會自己摸清楚該站欄位規則（國碼、手機碼數等）並調整，適用各種站。約 90 秒、走訂閱、會建立測試帳號。";
const inputs = [
...
module.exports = { id, name, description, category, inputs, buildPrompt };
